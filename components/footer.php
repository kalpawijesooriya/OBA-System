        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 site-footer-bx">
                <div id="site-footer-A3" class="text-center animated">
                    <h5>CONTACT</h5>
                    <p>
                        <span>PRINCE OBA</span>
                        <br>
                        <span>New town prince collage</span>
                        <br>
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 site-footer-bx">
                <div id="site-footer-A4" class="text-center animated">
                    ...
                    <ul class="list-inline site-social-icons">
                        <li><a href="https://www.facebook.com/Prince.oldboys.association" target="_blank"><i class="fa fa-facebook-square fa-lg" aria-hidden="true"></i></a></li>
