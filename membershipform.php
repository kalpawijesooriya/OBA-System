                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Id card no"  id="nic" name="nic" required>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <select id="title"class="form-control" name="title"  required><option label="Mr" value="Mr" selected="selected">Mr</option><option label="Dr" value="Dr">Dr</option><option label="Prof" value="Prof">Prof</option><option label="Rev" value="Rev">Rev</option><option label="Other" value="Other">Other</option></select>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="phone" name="phone" placeholder="Residence Phone Number" required>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="form-control-group">
                            ...
                            <div class="controls">
                                <input type="email" class="form-control" name="email" pattern="^[a-zA-Z0-9\-_]+(\.[a-zA-Z0-9\-_]+)*@[a-z0-9]+(\-[a-z0-9]+)*(\.[a-z0-9]+(\-[a-z0-9]+)*)*\.[a-z]{2,4}$"  id="email" placeholder="Email Address" required>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="form-control" name=index_num  placeholder="Index Number" id="index_num" required>
                            </div>
                        </div>
                    </div>      
                    <div class="col-md-3">
                        <div class="form-control-group">
                            ...
                            <div class="controls">
                                <input type="number" class="form-control" name="ol_year" placeholder="O/L Year" id="ol_year" required>
                            </div>
                        </div>
                    </div>      
                    <div class="col-md-3">
                        <div class="form-control-group">
                            ...
                            <div class="controls">
                                <input type="number" class="form-control" name="al_year" placeholder="A/L Year" id="al_year" required>
                            </div>
                        </div>
                    </div>   
                </div>                   
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <label class="control-label">Confirm Password<span class="required">*</span></label>                       
                            <div class="controls">
                                <input type="password" class="form-control" required="required" placeholder="Re-Enter Password" name="confirmPass" id="confirmPass" disabled required>
