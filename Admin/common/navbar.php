<div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a class="waves-effect"><i class="fa fa-user fa-fw" aria-hidden="true"></i>Members</a>
                        <ul class="nav nav-second-level">
                                <li>
                                    <a href="member-search.php">Search Members</a>
                                </li>
                                <li>
                                    <a href="member-register.php">Registration</a>
                                </li>
                            </ul>
                    </li>
                    <li>
