...
else if(!empty($_POST['nic']) || !empty($_FILES['file']['name'])|| !empty($_POST['title'])|| !empty($_POST['name'])|| !empty($_POST['phone'])|| !empty($_POST['birthday'])|| !empty($_POST['country'])|| !empty($_POST['address'])|| !empty($_POST['mobile'])|| !empty($_POST['index_num'])|| !empty($_POST['ol_year'])|| !empty($_POST['al_year'])|| !empty($_POST['password'])){
