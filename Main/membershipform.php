            ...
            <div class="well">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required" placeholder="Id card no" ng-model="reg.nic" ng-blur="alreadyMember()" ng-required="true" required="required">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required" name="initial" ng-blur="updateForm()" ng-disabled="!nic_update" placeholder="Initials" ng-model="reg.initial" ng-required="true" required="required" disabled="disabled">
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="form-group">
                            <label>Surname<span class="required">*</span></label>
                            <input type="text" class="form-control ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required" name="surname" ng-blur="updateForm()" ng-disabled="!nic_update" placeholder="Surname" ng-model="reg.surname" ng-required="true" required="required" disabled="disabled">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Names denoted in initials<span class="required">*</span></label>
                            <input type="text" class="form-control ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required" name="initial_name" ng-disabled="!nic_update" placeholder="Names denoted in initials" ng-blur="updateForm()" ng-model="reg.initial_name" ng-required="true" required="required" disabled="disabled">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="full_name" ng-readonly="true" value=" " readonly="readOnly">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required" name="birth_day" ng-disabled="!nic_update" placeholder="Birth Day" ng-blur="updateForm()" ng-model="reg.birth_day" ng-required="true" datepicker="" required="required" disabled="disabled">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Name Printed in ID Card (Max 25 character)<span class="required">*</span></label>
                            <input type="text" class="form-control ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required ng-valid-maxlength" name="id_name" ng-disabled="!nic_update" ng-maxlength="25" placeholder="Name Printed In ID Card" ng-blur="updateForm()" ng-model="reg.id_name" ng-required="true" required="required" disabled="disabled">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required" ng-disabled="!nic_update" name="street" ng-blur="updateForm()" ng-model="reg.address" ng-required="true" required="required" disabled="disabled">
                            <h6>Address - Include in Online Directory  <input type="checkbox" ng-blur="updateForm()" ng-disabled="!nic_update" ng-model="reg.address_visible" ng-true-value="&#39;1&#39;" class="ng-pristine ng-untouched ng-valid ng-not-empty" disabled="disabled"></h6>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required" name="residence_phone" ng-disabled="!nic_update" placeholder="Residence phone" ng-blur="updateForm()" ng-model="reg.residence_phone" ng-required="true" required="required" disabled="disabled">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            &nbsp;
                            <input type="text" class="form-control ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required" name="mobile" ng-disabled="!nic_update" placeholder="Mobile phone" ng-blur="updateForm()" ng-model="reg.mobile" ng-change="smsNumber()" ng-required="true" required="required" disabled="disabled">
                            <h6>Mobile - Include in Online Directory  <input type="checkbox" name="mobile_visible" ng-blur="updateForm()" ng-disabled="!nic_update" ng-model="reg.mobile_visible" ng-true-value="&#39;1&#39;" class="ng-pristine ng-untouched ng-valid ng-not-empty" disabled="disabled"></h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-control-group">
                            ...
                            &nbsp;
                            <div class="controls">
                                <input type="text" class="form-control ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required" ng-disabled="!nic_update" name="email" ng-blur="updateForm()" ng-model="reg.email" ng-required="true" required="required" disabled="disabled">
                            </div>
                            <h6>Email - Include in Online Directory  <input type="checkbox" ng-disabled="!nic_update" name="email_visible" ng-blur="updateForm()" ng-model="reg.email_visible" ng-true-value="&#39;1&#39;" class="ng-pristine ng-untouched ng-valid ng-not-empty" disabled="disabled"></h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Number to Send SMS<span class="required">*</span></label>
                            <input type="text" class="form-control ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required" placeholder="Should be a Sri Lankan Mobile Number" ng-disabled="!nic_update" name="sms_no" ng-blur="updateForm()" ng-model="reg.sms_no" ng-required="true" required="required" disabled="disabled">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="well">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <button type="submit" ng-disabled="submit_form" class="btn btn-primary  btn-dn-submit submit btn form-control">Submit</button>
                        </div>
                    </div>
                </div>
            </form>
